...
<!--meta http-equiv="content-type" content="text/html; charset=UTF-8"-->
	...
	<title>Mobile and Web Apps - Helloworld Nigeria</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="shortcut icon" href="images/favicon.png">
	<meta name="description" content="We develop great Web & Mobile Apps. Build and advance your career @ HELLOWORLD TECHNOLOGIES.">
...
<body class="ng-scope responsive">
<?php $this->beginBody() ?>
	...
	<div id="page-content">
			...
			<div class="container">
				<div class="navbar-header">
					<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-collapse">
						...
						<a class="logo navbar-brand" href="index.php" id="header-logo">
							<!--img alt="Helloworld Name" src="images/logo.png" style="width:276px;"--
							Helloworld - <small><em>Smart Developers</em></small>
						</a>
				...
				<nav class="navbar-collapse collapse text-center-xs" id="navbar-collapse" role="navigation">
						...
						<ul class="nav navbar-nav navbar-right">
							<li>
								<a id="sign-in" href="register.php" onclick="">Register</a>
							</li>
							<li>
								<a href="signin.php" onclick="">Sign In</a>
							</li>
						</ul>
							...
							<ul class="nav navbar-nav navbar-right">
									<li>
										<a class="dropdown-toggle" href="contact.php">Web & Mobile Services</a>
									</li>
							</ul>
							...
							<ul class="nav navbar-nav navbar-right">
								<li>
									<a href="courses.php">Web & Mobile Training</a>
								</li>
							</ul>
        ...
        <?php
            NavBar::begin([
                'brandLabel' => 'Helloworld Technologies',
            ...
            echo Nav::widget([
                ...
                'items' => [
            		['label' => 'Send SMS', 'url' => ['/sms/index']],
                    ['label' => 'Training', 'url' => ['/site/course']],
	...
	<div class="row">
		<div class="col-xs-6">
			<h1 class="h-slim-top">SMS Made Easier!</h1>
		</div>
		<div class="col-xs-6">
			<?= Breadcrumbs::widget([
	...
	<div class="row row-gap-medium">
		<div class="col-xs-3">
					...
					<ul class="nav nav-pills nav-stacked">					  
					  <li role="presentation" class="dropdown active">
					    ...
					    <ul class="dropdown-menu">
							<li role="presentation"><?php //=  Html::a('SEND SINGLE SMS', ['/message/create']); ?></li>
							<li role="presentation"><?php //=  Html::a('SEND BULK SMS', ['/message/bulk']); ?></li>
							<li role="presentation"><?php //=  Html::a('SEND GROUP SMS', ['/message/group']); ?></li>
					    </ul>
					  </li>					  
					  <li role="presentation"><?php //=  Html::a('SCHEDULED JOB', ['/schedule/index']); ?></li>
					  <li role="presentation"><?php //=  Html::a('ADDRESS BOOK', ['/addressbook/index']); ?></li>
					  <li role="presentation"><?php //=  Html::a('REPORTS', ['/message/report']); ?></li>
					  <li role="presentation"><?php //=  Html::a('MONTHLY SUMMARY', ['/site/summary']); ?></li>
					  <li role="presentation"><?php //=  (Yii::$app->user->isGuest) ? Html::a('LOG IN', ['/site/login']): Html::a('LOGOUT', ['/site/logout']); ?></li>
					</ul>	
				</div-->
				<div class="col-xs-12">
				<div id='cssmenu'>
					<ul>
					  ...
					  <li role="presentation"><?=  Html::a('REPORTS', ['/message/report']); ?></li>
					   <li role="presentation"><?=  Html::a('MONTHLY SUMMARY', ['/site/summary']); ?></li>
			...
			<div class="row">
				<div class="col-xs-12">
					<!--h4 class="h-slim"></h4>
					<form role="form">
						<div class="checkbox" data-ng-repeat="option in filter.options">
							<label>
								<input type="checkbox" name="{{filterId}}-{{option.name}}" data-ng-model="option.selected">
								<span data-ng-show="filter.makeTitleCase">{{option.name |titleCase}}</span>
								<span data-ng-hide="filter.makeTitleCase">{{option.name}}</span>
							</label>
						</div>
					</form-->
				</div>
		...
		<div class="col-xs-9 course-list">
			
			
			<div class="container" style="margin-bottom:3em;width:100%;">
...
<div class="row row-gap-medium ng-scope">
	<!-- ngView:  col-lg-6 col-lg-offset-3 -->
...
<h4>Follow us on</h4>
<a href="https://www.facebook.com/Helloworldng"><span class="sprite sprite-social sprite-facebook"></span></a>
<a href="#"><span class="sprite sprite-social sprite-twitter"></span></a>
<a href="#"><span class="sprite sprite-social sprite-gplus"></span></a>
<a href="#"><span class="sprite sprite-social sprite-linkedin"></span></a>
		...
		<!--div class="col-xs-12">
			<div class="text-center-xs">
				<a href="https://itunes.apple.com/us/app/id819700933?mt=8">
					<img alt="Apple store" class="img-initial mobile-button" src="images/5mY-J8xINNmZ4x_6mbNYmhDWFT_qzG4q4QA2jPzRfiqRjUticf5u0eEEATtX.png" >
				</a>
				<a href="https://play.google.com/store/apps/details?id=com.udacity.android">
					<img alt="Google Play" class="mobile-button" src="images/Zb2s5Ho_mzDPnb9dBDIqQPpwFrxz1e902ksTnir8Cs_KdrYLvN_TLVK1pmKG.png" >
				</a>
			</div>
		</div-->
	</div>
...
<h4>Follow us on</h4>
<a href="https://www.facebook.com/Helloworldng"><span class="sprite sprite-social sprite-facebook"></span></a>
<a href="https://twitter.com/helloworldng"><span class="sprite sprite-social sprite-twitter"></span></a>
<a href="#"><span class="sprite sprite-social sprite-gplus"></span></a>
<a href="#"><span class="sprite sprite-social sprite-linkedin"></span></a>
	...
	<div class="row">
		<div class="col-xs-12">
			<!--div class="text-center-xs">
				<a href="https://itunes.apple.com/us/app/id819700933?mt=8">
					<img alt="Apple store" class="img-initial mobile-button" src="Nanodegree%20%20A%20New%20Kind%20Of%20Credential%20For%20Jobs%20in%20Technology%20-%20Udacity_files/5mY-J8xINNmZ4x_6mbNYmhDWFT_qzG4q4QA2jPzRfiqRjUticf5u0eEEATtX.png" srcset="//lh6.ggpht.com/5mY-J8xINNmZ4x_6mbNYmhDWFT_qzG4q4QA2jPzRfiqRjUticf5u0eEEATtX04gbr_KrDSx8SDDBpGRHAWU=s300#w=300&amp;h=88 2x">
				</a>
				<a href="https://play.google.com/store/apps/details?id=com.udacity.android">
					<img alt="Google Play" class="mobile-button" src="Nanodegree%20%20A%20New%20Kind%20Of%20Credential%20For%20Jobs%20in%20Technology%20-%20Udacity_files/Zb2s5Ho_mzDPnb9dBDIqQPpwFrxz1e902ksTnir8Cs_KdrYLvN_TLVK1pmKG.png" srcset="//lh5.ggpht.com/Zb2s5Ho_mzDPnb9dBDIqQPpwFrxz1e902ksTnir8Cs_KdrYLvN_TLVK1pmKGbMPgolJ2wIlY23yI9OODDss=s300#w=300&amp;h=88 2x">
				</a>
			</div-->
		</div>
	</div>
...
<link rel="stylesheet" type="text/css" href="css/fonts.css" media="print">
