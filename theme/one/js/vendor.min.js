...
$(function(){var e=$('meta[name="x-stripe-key"]').attr("content");"undefined"!=typeof StripeCheckout&&e&&($(document).on("click",".action-change-payment-info",function(a){a.preventDefault();var t=$(a.target).attr("data-scope-name"),n=StripeCheckout.configure({key:e,image:"/static/images/n-64.png",name:"npm, Inc.",billingAddress:!0,token:function(e,a){var n={};$(".org-billing-email-view .media-body p").text(e.email),$("#userEmail").val(e.email),Object.keys(e.card).forEach(function(a){n[a]=$(".output-"+a).text(),$(".output-"+a).text(e.card[a])}),$.ajax({method:"POST",json:!0,url:"/settings/api/billing",data:{stripeToken:e.id,email:e.email,scope:t,step3:Boolean(t),crumb:window.crumb},headers:{"x-csrf-token":window.crumb}}).then(function(e){$(".org-billing-email-view").text(e.email),Object.keys(e.card).forEach(function(a){$(".output-"+a).text(e.card[a])})},function(e){Object.keys(n).forEach(function(e){$(".output-"+e).text(n[e])}),$(".alert-container .alert").slideUp(function(){$(this).remove()});var a=$('<div class="alert alert-error alert-dismissable"><button class="close" data-dismiss="alert"><i class="fa fa-times"></i></button><div class="media mtn"><div class="media-left"><i class="fa alert-icon fa-exclamation-triangle"></i></div><div class="media-body em-high">There was an error updating your payment information.</div></div></div>').hide();$(".alert-container").append(a),a.slideDown()})}});n.open({panelLabel:"Update Card"})}),$(window).on("popstate",function(){changeCardHandler.close()}),$(".action-checkout").each(function(){var a=$(this),t=StripeCheckout.configure({key:e,image:"/static/images/n-64.png",billingAddress:!0,name:"npm, Inc.",token:function(e,t){a.find('[name="stripeToken"]').val(e.id),a.find('[name="email"]').val(e.email),a.is("#subscribe-private-packages-form")&&ga&&(ga("ec:addProduct",{id:"solo",name:"npm Solo",category:"SaaS",price:"7.00",quantity:"1"}),ga("ec:setAction","purchase",{id:e.id,coupon:null}),ga("send","event","SaaS","Solo Purchase")),a.is("#create-org-form")&&ga&&(ga("ec:addProduct",{id:"orgs-7",name:"npm Orgs",category:"SaaS",price:"7.00",quantity:"2"}),ga("ec:setAction","purchase",{id:e.id,coupon:null}),ga("send","event","SaaS","Orgs Purchase")),a.submit()}});a.is("[data-need-card]")&&(a.is("[data-open-signup]")&&(ga&&(ga("ec:addProduct",{id:"solo",name:"npmSolo",category:"SaaS",price:"7.00",quantity:1}),ga("ec:setAction","checkout",{step:2}),ga("send","event","SaaS","Solo Subscription")),t.open({amount:a.find("[name=amount]").val()})),a.on("submit",function(e){var n=$("#org-plan-type-free").is(":checked");a.find('[name="stripeToken"]').val()||n||(e.preventDefault(),t.open({amount:a.find("[name=amount]").val()}))})),$(window).on("popstate",function(){t.close()})}))});