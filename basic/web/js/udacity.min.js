...
angular.module("core").config(["$locationProvider",function(a){a.html5Mode(!1);a.hashPrefix("!")}]).run(["dateTime","secondsSinceEpoch",function(a,d){a.initialize(1E3*d)}]).run(["optimizely",function(a){a.activate()}]);angular.module("page.account",["ngRoute","core","account"]);
angular.module("page.account").config(["$locationProvider","$routeProvider","cacheVersion","siteExperience",function(a,d,b,c){a=function(a){return c.managedAccount?{redirectTo:"/classroom-settings"}:a};d.when("/password",a({templateUrl:"/templates/angular/account/password.html?"+b,controller:"passwordTab"})).when("/my-courses",a({templateUrl:"/templates/angular/account/my_courses.html?"+b,controller:"myCoursesTab"})).when("/my-certificates",a({templateUrl:"/templates/angular/account/my_certificates.html?"+
b,controller:"myCertificatesTab"})).when("/billing-and-subscriptions",a({templateUrl:"/templates/angular/account/billing_and_subscriptions.html?"+b,controller:"billingAndSubscriptionsTab"})).when("/linked-accounts",{templateUrl:"/templates/angular/account/linked_accounts.html?"+b,controller:"linkedAccountsTab"}).when("/classroom-settings",{templateUrl:"/templates/angular/account/viewer_settings.html?"+b,controller:"viewerSettings"}).when("/memberships",a({templateUrl:"/templates/angular/account/membership.html?"+
b,controller:"membershipPage"})).otherwise(a({templateUrl:"/templates/angular/account/contact_info.html?"+b,controller:"contactInfoTab"}))}]);angular.module("account").controller("accountPage",["$scope","$location",function(a,d){a.isActive=function(a){return d.path()?d.path()===a:"/contact-info"===a}}]);angular.module("account").controller("billingAndSubscriptionsTab",["$scope","currentUser","modal","stripeCreditCard","customers",function(a,d,b,c,e){a.loading=!0;a.editingCreditCard=!1;a.enabledCreditCardButton=!0;a.creditCardErrorMessage="";a.removePaymentCard=function(c){a.loading=!0;return null===a.customer.subscriptions||0===a.customer.subscriptions.length?b.activate("removeCard").then(function(){return e.removeCreditCard("me",c).then(function(){a.customerCard=null;a.serverSuccess=!0},function(){a.serverError=
...
function(b){a.serverError=b.error;a.saveDisabled=!1}):a.saveDisabled=!1}}}]);angular.module("account").controller("linkedAccountsTab",["$scope","$timeout","currentUser","users","google","facebook","normalizedSocialService","session","siteExperience",function(a,d,b,c,e,f,g,h,i){a.loading=!0;a.managed=i.managedAccount;a.accounts={google:null,facebook:null};var j=function(){a.serverSuccess="";a.serverError=""},k=function(b,c,e){c=g.normalizeAccount(b,c);c.id===a.user["_"+b+"_id"]||e?c.loggedIn=!0:c={loggedIn:!1};return a.accounts[b]=c},l=function(b){a.loading=!1;a.serverError=
b.error};a.getLinkedAccountTypes=function(){return _.keys(a.accounts)};a.disconnect=function(b){a.loading=!0;var e={key:a.user.key};e[b+"_id"]=null;c.put(e).then(function(c){j();a.loading=!1;a.user=c;"github"!==b&&(a.accounts[b]=null)},l)};a.disconnectSocial=function(b){a.loading=!0;var e={key:a.user.key},d;_.each(a.user.social_accounts,function(a,c){a.account_type===b&&(d=c)});a.user.social_accounts.splice(d,1);e.social_accounts=a.user.social_accounts;c.put(e).then(function(c){j();a.loading=!1;a.user=
c;a[b]=null},l)};a.connect=function(b){a.loading=!0;var e=g.normalizeAccountService(b),f=function(g,h){var i=function(a){401===a.code&&f(g-1,3*h)};0===g&&(i=l);d(function(){e.getAccount().then(function(e){var d={key:a.user.key};d[b+"_id"]=e.id;c.put(d).then(function(c){e=k(b,e,!0);j();a.loading=!1;a.user=c},l)},i)},h)},i=function(){f(3,500)};e.login().then(function(a){a=g.createSessionData(b,a);h.put(a).then(i,i)},l)};j();b.fetchFullUser().then(function(){a.loading=!1;a.user=b.getUser();_.each(a.user.social_accounts,
function(b){a[b.affiliate_program_key]=b});_.each(a.getLinkedAccountTypes(),function(a){g.normalizeAccountService(a).getAccount().then(function(b){k(a,b)})})},l)}]);angular.module("account").controller("myCertificatesTab",["$q","$scope","$sce","currentUser","users","nodes",function(a,d,b,c,e,f){d.loading=!0;d.verifiedCertificates=[];d.nodeMap={};d.serverError="";var g=c.getUser();d.getBadges=function(){return _.filter(g._badges,function(a){return"Course Mastery"===a.name&&0<a.highest_level})};a.all([e.getCertificates("me").then(function(a){d.verifiedCertificates=a;a=_.map(a,function(a){return a.node_ref.key});return f.batchGet(a,{projection:"catalog"}).then(function(a){_.extend(d.nodeMap,
...
!0;c.append($("<iframe />",{src:a.data.url,"class":"tutoring-whiteboard-frame"}));d.showWhiteboard=!0;window.olark("api.chat.sendNotificationToOperator",{body:"Opened whiteboard.\nStudent's link (for troubleshooting): "+a.data.url+"\nYour link: "+(location.protocol+"//"+location.hostname+(location.port?":"+location.port:"")+"/api/session/whiteboard?unique_id="+a.data.unique_id+"&redirect=true")})}))})}}}]);angular.module("utility").controller("woodhouseCommands",["currentUser","$routeParams","$location","techDetect","$window",function(a,d,b,c,e){var f={};e.olark("api.chat.onCommandFromOperator",function(g){"woodhouseNameRequest"===g.command.name?e.olark("api.chat.sendNotificationToOperator",{body:"automatedResponse nameUpdateForUser *woodhouse-delimeter*"+a.get("first_name")+" "+a.get("last_name")}):"woodhouseInitialCourseRequest"===g.command.name?e.olark("api.chat.sendNotificationToOperator",{body:"automatedResponse courseInitForUser *woodhouse-delimeter*"+
(d.courseKey||b.path().split("c-")[1].split("/")[0])}):"woodhouseCourseRequest"===g.command.name?e.olark("api.chat.sendNotificationToOperator",{body:"automatedResponse courseUpdateForUser *woodhouse-delimeter*"+(d.courseKey||b.path().split("c-")[1].split("/")[0])}):"woodhouseEmailRequest"===g.command.name?a.get("email")&&a.get("email").address&&e.olark("api.chat.sendNotificationToOperator",{body:"automatedResponse emailUpdateForUser *woodhouse-delimeter*"+a.get("email").address}):"woodhouseLocationRequest"===
g.command.name?e.olark("api.chat.sendNotificationToOperator",{body:"automatedResponse locationUpdateForUser *woodhouse-delimeter*"+b.absUrl()}):"woodhouseIdRequest"===g.command.name?e.olark("api.chat.sendNotificationToOperator",{body:"automatedResponse idUpdateForUser *woodhouse-delimeter*"+a.get("key")}):"woodhouseTechRequest"===g.command.name?e.olark("api.chat.sendNotificationToOperator",{body:"automatedResponse techUpdateForUser *woodhouse-delimeter*"+JSON.stringify(c.getAllTech())}):"woodhouseSetUserDetail"===
g.command.name?(g=g.command.body.split("*woodhouse-delimeter*"),f[g[0]]=g[1],e.olark("api.chat.updateVisitorStatus",{snippet:_.map(f,function(a,b){return b+": "+a})})):"alert"===g.command.name&&e.alert(g.command.body||"Udacity requests your attention!")})}]);angular.module("filters").filter("allowUnsafe",["$sce",function(a){return function(d){return a.trustAsHtml(d)}}]);angular.module("filters").filter("dateRelative",["$filter",function(a){return function(d){if(!d||isNaN(d))return"not available";var b=((new Date).getTime()-d)/1E3;return 60>b?"just now":3600>b?""+Math.floor(b/60)+"m ago":86400>b?""+Math.floor(b/3600)+"h ago":691200>b?""+Math.floor(b/86400)+"d ago":28944E3>b?a("date")(d,"MMM d"):a("date")(d,"MMM d, yyyy")}}]).filter("dateRelativeNoYear",["$filter",function(a){return function(d){d=a("dateRelative")(d);return/, \d{4}$/g.test(d)?d.substring(0,d.length-
...
5E3+d.name.toLowerCase()})},match:function(a,b){return _.any(a.affiliate_program_refs,function(a){return _.any(b,function(b){return b.key===a.key})})}},{id:"paid",name:"Free Trial Available",hideTitle:!0,generateOptions:function(a,b,d){return[{name:"Free Trial Available",selected:"true"===d.full}]},match:function(a){return a.open_for_enrollment}},{id:"legacy",name:"Hide Legacy Courses",hideTitle:!0,generateOptions:function(a,b,d){return[{name:"Hide Legacy Courses",selected:"true"!==d.legacy}]},match:function(a,
b){return b.length&&!_.contains(d,a.key)}}];return{initializeFilters:function(a,d,f){_.each(b,function(b){b.options=b.generateOptions(a,d,f)});return b},_filters:b}}]);angular.module("courseCatalog").directive("courseSummary",["$location","cacheVersion",function(a,d){var b={beginner:1,intermediate:2,advanced:3};return{scope:{course:"=",affiliateMap:"="},templateUrl:"/templates/angular/course_catalog/course_summary.html?"+d,link:function(a){a.levelClass=function(){return"icon-level-"+b[a.course.level]}}}}]);angular.module("dashboard").controller("dashboardPage",["$scope","$routeParams","$window","$q","currentUser","nodes","nodeStates","nodeUtility","users","siteExperience","dateTime","$sce","$filter","gaqHelper",function(a,d,b,c,e,f,g,h,i,j){a.courseKey=d.courseKey;var k=null,l={};a.completedLessonKeys=[];a.nodeMap={};a.courseState={};a.loading=!0;a.$on("$routeChangeSuccess",function(){a.courseKey=d.courseKey;a.enrollment=_.find(e.get("_enrollments"),function(b){return b.node_key===a.courseKey});c.all([f.batchGet([a.courseKey],
{depth:1,projection:"dashboard",required_behavior:"view"}).then(function(b){b[a.courseKey].steps_refs=_.filter(b[a.courseKey].steps_refs,function(a){return b[a.key]});a.nodeMap=b;a.course=b[a.courseKey]}),g.get("me",a.courseKey).then(function(b){_.extend(a.courseState,b)}),g.get("me",a.courseKey,{projection:"progress"}).then(function(b){_.extend(a.courseState,b);if(b){var b=_.filter(_.pairs(b.progress),function(a){return a[1].last_interaction_time}),c=null;0<b.length&&(c=_.sortBy(_.reject(b,function(b){return b[0]===
a.courseKey}),function(a){return a[1].last_interaction_time}).reverse()[0][0]);b=c}else b=null;a.lastInteractedLessonKey=b}),i.getCertificates("me").then(function(a){k=a;_.each(k,function(a){var b=a.node_ref.key;_.has(l,b)?l[b].last_modification_time<a.last_modification_time&&(l[b]=a):l[b]=a})})]).then(function(){a.loading=!1;a.premiumAccess=h.hasPermissionTo(a.course,"view-paid-supplemental-media")||h.isCurrentEnrolled(a.enrollment,a.course)||h.isGraduated(a.enrollment,a.course)})});a.getCompletedLessonKeys=
function(a){return a?_.unique(_.pluck(a.completed_descendant_node_refs,"key")):[]};a.isComplete=function(b,c){return _.contains(a.getCompletedLessonKeys(c),b)};a.isPartiallyComplete=function(a,b){return b&&b.progress&&b.progress[a]?0<b.progress[a].completed_morsel_count:!1};a.getCertificate=function(a){return l[a]};a.isCurrentEnrolled=h.isCurrentEnrolled;a.isGraduated=h.isGraduated;a.managedAccount=j.managedAccount}]);angular.module("page.dashboard",["ngRoute","core","dashboard"]);angular.module("page.dashboard").config(["$locationProvider","$routeProvider","tags","cacheVersion",function(a,d,b,c){d.when("/"+b.course+":courseKey",{templateUrl:"/templates/angular/dashboard.html?"+c})}]);angular.module("account").controller("membershipPage").controller("membershipPage",["$scope","api","groups","currentUser",function(a,d,b,c){a.memberships=[];a.ready=!1;a.leaveGroup=function(b){a.error=null;d.post("/users/me/memberships",{group_keys_to_leave:["Group."+b]}).then(function(b){var c=$.map(b.data.group_refs_left,function(a){return a.key});a.memberships=_.reject(a.memberships,function(a){return _.contains(c,a.groupId)})},function(b){a.error="Failed to leave group ("+b.status+")"})};a.joinGroup=
...
"Group"===a.group_ref.ref&&e(a.group_ref.key)});a.ready=!0})}]);angular.module("overview").directive("nanodegreeEnrollmentActions",["cacheVersion","currentUser","groups","$location","dateTime","$window","adrollTracker","gaqHelper","cookieJar","googleTagManager",function(a,d,b,c,e,f,g,h,i,j){return{restrict:"A",scope:{enrollmentActions:"="},templateUrl:"/templates/overview/nanodegree_enrollment_actions.html?"+a,controller:"enrollmentActionsHelper",link:function(a){var b=function(a){return{nd001:{start:"Feb. 4 at noon Eastern Time",end:"Jan. 12 at 11:59 pm Eastern Time"},
nd002:{start:"Feb. 4 at noon Eastern Time",end:"Jan. 12 at 11:59 pm Eastern Time"},nd003:{start:"Mar. 4 at noon Eastern Time",end:"Mar. 9 at 11:59 pm Eastern Time"},nd004:{start:"Feb. 4 at noon Eastern Time",end:"Feb. 9 at 11:59 pm Eastern Time"}}[a]||{}};a.getNanodegreeButtonInfo=function(){return a.isAccessible&&(a.isPaidEnrolled||a.isPaidGraduated)?{variant:"nanodegree is live, student is enrolled or graduated",text:"Continue nanodegree",action:a._goToClass}:a.isPaidEnrollable?a.isClassFull?a.isPaidWaitlisted?
(i.exists("udacity_notify_me_clicked_recently")&&(j.pushTrackingEvent("notificationListJoin"),h.pushTrackingEvent("Waitlist","SignUp",a.courseKey),i.remove("udacity_notify_me_clicked_recently")),{variant:"nanodegree is full, student is waitlisted",statusMessage:"You will be emailed when enrollment opens "+b(a.courseKey).start,statusSuccess:!0}):{variant:"nanodegree is full, student not waitlisted, not enrolled",text:"Notify me",sidenote:"when nanodegree re-opens",statusMessage:"<strong>Next enrollment opens "+
b(a.courseKey).start+".</strong><br>You can start the program immediately after you enroll.",action:function(){g.track(a.courseKey+"notify").then(function(){i.set("udacity_notify_me_clicked_recently","yes",{expires:new Date((new Date).getTime()+6E5)});a._joinGroup(a.waitlistGroupKey)})}}:{variant:"nanodegree live, student not enrolled",text:"Enroll in nanodegree",sidenote:"One week trial",statusMessage:"You can start the program immediately after you enroll. <br><strong>Enrollment closes "+b(a.courseKey).end+
".</strong>",action:function(){g.track(a.courseKey+"enroll").then(function(){a._purchaseCourse()})}}:{variant:"nanodegree not open for paid enrollment",sidenote:"This nanodegree is not yet available for enrollment"}};a=_.extend(a,a.enrollmentActions);a.productLaunchDate=new Date(a.productLaunchDateString);a.hasProductLaunched=a.enrollmentActions.isLaunched;a.isVIP=a.isAccessible&&(!a.isAvailable&&!a.isLaunched||a.canEditContent)&&a.getNanodegreeButtonInfo().action!==a._goToClass;a.isFull=a.isClassFull&&
!(a.isPaidInterested||a.isPaidEnrolled||a.isPaidGraduated)}}}]);angular.module("overview").controller("nanodegreePortal",["$scope","cacheVersion","nodes","$window","currentUser","dateTime","api","$timeout","$q","productState","modal",function(a,d,b,c,e,f,g,h,i,j,k){var l={};a.submissions={};a.submissionsFetched={};a.launchHangoutOnAir=function(a,b){k.activate(a).finally(function(){var a=$("#"+b),c=a.attr("src");a.attr("src","");a.attr("src",c)})};a.dismiss=function(){k.confirm()};var m=function(b){var b=b||0,c=_.find(a.submissionsFetched,function(a){return!a});
angular.isUndefined(c)?(_.each(a.lessons,function(b){var c=a.lessonStates.showCheckmark,d=b.key;b="Project"===b._semantic_type?a.submissions[b.key]&&0<a.submissions[b.key].length&&a.submissions[b.key][0].project_report?(b=a.submissions[b.key][0].project_report)&&b._completed&&("DISTINCTION"===b._rating||"PASSED"===b._rating):!1:a.lessonStates.completed[b.key];c[d]=b}),c=_.find(a.lessonKeys,function(b){return!a.lessonStates.showCheckmark[b]}),l[c]=!0):h(function(){m(b+1)},Math.pow(2,b))},p=function(a,
b){return g.get("/users/me/nodestates",{node_keys:a}).then(function(a){_.each(a.data.nodestates,function(a){b.completed[a.node_ref.key]=a.node_completed||b.completed[a.node_ref.key];b.visited[a.node_ref.key]=!0})})};a.toggleOpenLesson=function(a){l[a]=!l[a]};a.showOpenLesson=function(a){return l[a]};a.markLessonAsComplete=function(b,c){c=c||1;a.lessonStates.completed[b]=!0;l[b]=!1;m();var d={items:[{content_context:[{node_key:a.nanodegree.key,tag:"c-"},{node_key:b,tag:"l-"}],data:{model:"CompletedExperience",
...
"/course/viewer#!/c-"+c.encodeURIComponent(b)})};a.nanodegreeKey=j.courseKey;a.loadingMessage="Loading projects";a.lessons=[];b.batchGet([a.nanodegreeKey],{depth:1}).then(function(c){a.loadingMessage="Checking Progress";a.courses={};a.nanodegree=c[a.nanodegreeKey];a.lessonKeys=_.pluck(a.nanodegree.steps_refs,"key");a.lessonKeys=_.filter(a.lessonKeys,function(a){return c[a]});a.lessons=_.map(a.lessonKeys,function(b){l[b]=!1;"Project"===c[b]._semantic_type&&(a.submissionsFetched[b]=!1);return c[b]});
a.relatedCourses=_.pluck(a.nanodegree.overview_details.related_course_refs,"key");var d=a.relatedCourses;b.batchGet(d).then(function(b){_.each(d,function(c){var d=b[c];if(d){var e=null,f=d.catalog_entry;f&&f._image&&(e=f._image.serving_url);a.courses[c]={key:c,imageUrl:e,title:d.title||"Title for testing"}}})},function(a){console.warning("failed to fetch nodes"+a.data.error)});a.lessonStates={};a.lessonStates.completed={};a.lessonStates.showCheckmark={};a.lessonStates.visited={};i.all([b.state(a.nanodegreeKey,
"me").then(function(b){b&&_.each(b.completed_descendant_node_refs,function(b){a.lessonStates.completed[b.key]=!0})}),p(a.lessonKeys,a.lessonStates)]).then(function(){a.loadingMessage=null;m()});a.courseStates={};a.courseStates.completed={};a.courseStates.visited={};p(a.relatedCourses,a.courseStates)})}]);angular.module("overview").directive("projectSubmissions",["cacheVersion","projects","fileQueue",function(a,d,b){return{restrict:"A",scope:{projectKey:"=",submissions:"=",submissionsFetched:"="},templateUrl:"/templates/projects/project_submissions.html?"+a,link:function(a){a.showLinkSubmission=!1;a.pickedFiles={};a.showSubmissionOptions={};var e=function(){return d.getSubmissionsBySearch({node_key:a.projectKey,student_key:"me",limit:100}).then(function(b){b=_.filter(b.submissions,function(a){return a.project_report&&
a.project_report._completed&&"UNGRADED"===a.project_report._rating?!1:a._submission_link||a._submission_file||a._submission_text||a.project_report});a.submissions[a.projectKey]=_.sortBy(b,function(a){return a._creation_time}).reverse();b=a.submissions[a.projectKey];0===b.length?a.showSubmissionOptions=!0:(b=_.first(b).project_report,a.showSubmissionOptions=b&&b._completed&&"INCOMPLETE"===b._rating);return a.submissions})},f=function(){a.showLinkSubmission=!1;a.submitting=!1;a.authorshipConfirmed=
!1;a.error=!1},g=d.createSubmission;a.submitFile=function(f){a.error=!1;a.submitting=!0;return g(a.projectKey).then(function(g){return d.getSubmissionUploadUrl(g.key).then(function(d){return b.fileUploadTask(d,a.pickedFiles[f]).then(function(){a.pickedFiles[f]=null;return e()})})},function(){a.error=!0;a.submitting=!1})};a.showLinkSubmissionOption=function(){a.showLinkSubmission=!0};a.cancelSubmission=function(b){a.pickedFiles[b]=null;f(b)};a.submitLink=function(b,d){a.submitting=!0;return g(a.projectKey,
b,d).then(function(){return e()["finally"](f)},function(){a.error=!0;a.submitting=!1})};e().finally(function(){a.submissionsFetched[a.projectKey]=!0})}}}]);angular.module("overview").directive("courseEnrollmentActions",["cacheVersion","currentUser","groups","$location","dateTime","$window","adrollTracker","courseState","modal",function(a,d,b,c,e,f,g,h,i){return{restrict:"A",scope:{enrollmentActions:"="},templateUrl:"/templates/overview/course_enrollment_actions.html?"+a,controller:"enrollmentActionsHelper",link:function(a){a.courseState=h;a.currentHighlightedFeature=0;a.freeCourseActionDefaultSectionTitle="Access Course Materials";a.paidCourseActionDefaultSectionTitle=
"Enroll in Course";a.activateTimeExpectationExperiment=function(){"class is live, student not enrolled"===a.getPaidCourseActionConfiguration().variant&&f.optimizely&&(f.optimizely.push(["trackEvent","run_trial_screener_experiment"]),f.optimizely.activate())};window.setInterval(function(){a.currentHighlightedFeature=(a.currentHighlightedFeature+1)%5;a.$apply()},4E3);a.getPaidCourseActionConfiguration=function(){if(a.isAccessible&&a.isPaidEnrolled)return{variant:"class is live, student is enrolled",
text:"Go to class",hidePrice:!0,hideFeatures:!0,action:a._goToClass};if(a.hasProductLaunched)if(a.isPaidEnrollable){if(a.isClassFull&&a.isPaidWaitlisted)return{variant:"class is full, student is waitlisted",statusMessage:"You will be be notified when course enrollment is open. You can access course materials now."};if(a.isClassFull)return{variant:"class is full, student not enrolled",text:"Notify me",note:"Get notified when enrollment is open",sectionTitle:"Enrollment is at capacity",hideFeatures:!0,
action:function(){g.track(a.courseKey+"notify").then(function(){a._joinGroup(a.waitlistGroupKey)})}};if(a.hasProductLaunched)return{variant:"class is live, student not enrolled",text:"Start free trial",note:a.spotsRemaining&&20>=a.spotsRemaining?"Only "+a.spotsRemaining+" seats left!":null,action:function(){g.track(a.courseKey+"enroll").then(function(){a._purchaseCourse()})}}}else return{variant:"class not open for paid enrollment",hideSectionTitle:!0};else return{variant:"class not live",hideSectionTitle:!0}};
a.showTimeExpectationModal=function(){i.activate("time_commitment")};a.getFreeCourseActionConfiguration=function(){return a.isPaidEnrolled?{variant:"class is live, student is paid enrolled",hideSectionTitle:!0,placeholder:"You're all set, dive in!"}:a.isAccessible&&a.isFreeEnrolled?{variant:"class is live, student is enrolled",text:"Resume course materials",action:a._goToClass}:a.isAvailable&&a.isEnrollable?{variant:"class is live, student not enrolled",text:"Access course materials",action:function(){g.track(a.courseKey+
"free").then(function(){a._enrollInCourseware()})}}:a.isFreeInterested?{variant:"class not live, student is interested",hideSectionTitle:!0,statusMessage:"You will be notified when the course is open."}:a.isEnrollable?{variant:"class not live, student not registered",text:"Notify me",note:"Get notified when the course is open",hidePrice:!0,hideFeatures:!0,action:function(){a._joinGroup(a.notificationGroupKey)}}:{variant:"error"}};a=_.extend(a,a.enrollmentActions);a.productLaunchDate=new Date(a.productLaunchDateString);
a.hasProductLaunched=a.enrollmentActions.isLaunched;a.isVIP=a.isAccessible&&!a.isAvailable&&a.getFreeCourseActionConfiguration().action!==a._goToClass&&a.getPaidCourseActionConfiguration().action!==a._goToClass}}}]);angular.module("overview").directive("courseOverviewPage",function(){return{require:"overviewPage",controller:["$scope","courseState",function(a,d){a.courseState=d}]}});angular.module("overview").controller("enrollmentActionsHelper",["$scope","cacheVersion","currentUser","groups","$location","dateTime","$window",function(a,d,b,c,e,f,g){a._goToClass=function(){g.location.href="/course/viewer#!/c-"+g.encodeURIComponent(a.courseKey)};a._purchaseCourse=function(b){g.location.href="/checkout#!/0?products="+g.encodeURIComponent(b||a.productKey)};a._joinGroup=function(d){b.userIsLoggedIn()?(a.disableCoursewareAction=!0,c.addMember(d,"me").then(function(){a.disableCoursewareAction=
...
(a.fieldErrors=e.errorText,a.buttonDisabled=!1)};a.signInFacebook=function(){return j.getAuthResponse().then(function(a){return c.put({facebook:{signed_request:a.signedRequest}}).then(p,r)},n)};a.signInGoogle=function(){i.getToken(!1).then(function(a){return c.put({google:{token:a.code}}).then(p,r)},n)}}]);angular.module("account").controller("signUpForm",["$scope","$q","$sce","$timeout","session","users","currentUser","groups","validator","google","facebook","$location","safelyRedirect","gaqHelper","googleTagManager","retry","cookieJar",function(a,d,b,c,e,f,g,h,i,j,k,l,m,p,n,r,q){a._removeEmailCookie=function(){q.exists("emailAddressForSignUp")&&q.remove("emailAddressForSignUp",{path:"/"})};var t=function(){var b=function(){var b=a.initialSearch.next;b?m(b):m("/")},c=a.initialSearch.enroll,e=a.initialSearch.enroll_state||
"enrolled",f=a.initialSearch["join-group"],e=c?g.enroll(c,e,!0):d.when(!0),i=f?g.fetchFullUser().then(function(){return h.addMember(f,g.get("key"))}):d.when(!0),j,k;a._removeEmailCookie();j=c?p.pushTrackingEvent("SignUp","Enroll",c):p.pushTrackingEvent("SignUp","Direct");k=n.pushTrackingEvent("RegistrationCompleted");return e["finally"](function(){return i["finally"](function(){return j["finally"](function(){return k["finally"](b)})})})},u=function(c){a.errorMessage=b.trustAsHtml("We were unable to validate your account.");
return d.reject(c)},v=function(c){a.errorMessage=b.trustAsHtml("We were unable to access your account.");return d.reject(c)},s=function(c){409===c.data.status?(a.errorMessage=b.trustAsHtml("This account already exists, please sign in to continue."),a._removeEmailCookie()):a.errorMessage=b.trustAsHtml("Something went wrong and we're currently looking into it.");a.buttonDisabled=!1;return d.reject(c)};a.signUpEmail=function(){a.buttonDisabled=!0;a.errorMessage=null;a.fieldErrors=null;var b=i.check({email:{pretty:"your email address",
value:a.email,validators:[{type:"required",chained:[{type:"email"}]}]},password:{pretty:"your password",value:a.password,validators:[{type:"required",chained:[{type:"strLen",args:[7,void 0]}]}]},firstName:{pretty:"your first name",value:a.firstName,validators:[{type:"required"}]},lastName:{pretty:"your last name",value:a.lastName,validators:[{type:"required"}]}});b.valid?f.registerUser({email_address:a.email,first_name:a.firstName,last_name:a.lastName,password:a.password,tos_accepted:!0}).then(t,
s):(a.fieldErrors=b.errorText,a.buttonDisabled=!1)};a.signUpFacebook=function(){return k.getAuthResponse().then(function(a){return k.getMeResponse().then(function(b){return f.registerUser({email_address:b.email,first_name:b.first_name,last_name:b.last_name,facebook:{signed_request:a.signedRequest},tos_accepted:!0}).then(t,s)},v)},u)};a.signUpGoogle=function(){j.getToken(!1).then(function(a){return e.put({google:{token:a.code}}).then(t,function(){return r(j.getMeResponse,5,100).then(function(a){return j.getToken(!0).then(function(b){return f.registerUser({email_address:a.email,
first_name:a.given_name,last_name:a.family_name,google:{token:b.code},tos_accepted:!0}).then(t,s)},u)},v)})},u)};q.exists("emailAddressForSignUp")&&(a.email=q.get("emailAddressForSignUp"))}]);angular.module("account").controller("viewerSettings",["$scope","currentUser","users","techDetect","$window",function(a,d,b,c){a.isBrowserIE="Explorer"===c.browserStats().browser;a.videoQualities=[{label:"Automatic",value:"default"},{label:"360p",value:"medium"},{label:"480p",value:"large"},{label:"720p",value:"hd720"},{label:"1080p",value:"hd1080"}];a.playbackRates=[{label:"0.25x",value:0.25},{label:"0.5x",value:0.5},{label:"Normal",value:1},{label:"1.5x",value:1.5},{label:"2x",value:2}];var e=d.getUser();
...
a.save=function(){a.serverSuccess=a.serverError="";a.saving=!0;e.site_preferences={use_html5_player:a.settings.useHtml5Player,auto_advance:a.settings.autoAdvance,playback_rate:a.settings.playbackRate.value,video_quality:a.settings.videoQuality.value};b.put(e).then(function(){a.saving=!1;a.serverSuccess="Classroom Settings Saved"},function(b){a.saving=!1;a.serverError=b.error})}}]);angular.module("payment").controller("checkoutPage",["$scope","paymentFlow","$routeParams","$location","api","gaqHelper","currentUser","cacheVersion","modal","dateTime","optimizely","$timeout",function(a,d,b,c,e,f,g,h,i,j,k,l){g.get("_registered")||(window.location.href="/account/auth#!/signup?next="+encodeURIComponent(window.location.href));a.$on("$routeChangeSuccess",function(){f.pushPageviewEvent();if(angular.isDefined(b.stepNumber)&&d.isInFlow())d.goToStep(b.stepNumber);else{var e=[];c.search().products?
(e=c.search().products.split(","),d.begin(e),a.flow=d.getCurrentFlowData()):window.history.back()}});a.getCurrentDate=function(){return j.getCurrent()};a.isProductLaunched=function(a){return a&&a.launch_date&&new Date(a.launch_date)<j.getCurrent()};a.isProductNotLaunched=function(a){return a&&!a.was_launched};a.getDatePlusDays=function(a,b){return a?new Date(a.getTime()+864E5*b):null};a.step={};a.submitStep=function(b){a.step.submitting=!0;d.submitStep(b).then(function(){a.step.submitting=!1;$("html,body").animate({scrollTop:0})})};
a.getCacheBustingUrl=function(a){return a&&a+"?"+h};a.currentUserName=g.getFullName();a.currentUserEmail=g.get("email").address;a.currentUserNickname=g.get("nickname");a.getCurrentUserIsVerified=function(){return g.get("email")._verified};a.getCurrentStep=d.getCurrentStep;a.getCurrentFlowSteps=d.getCurrentFlowSteps;l(function(){!a.getCurrentUserIsVerified()&&!window.optimizelyDisableVerificationModal&&i.activate("verify email")},1);a.$on("$includeContentLoaded",function(){k.activate()})}]);angular.module("page.payment",["core"]).config(["$routeProvider",function(a){a.when("/:stepNumber",{}).otherwise({redirectTo:"/0"})}]);angular.module("payment").constant("DAY_IN_MILLISECONDS",864E5).factory("fullClassExperienceFlowDefinition",["$q","stripeCreditCard","validator","api","currentUser","products","customers","adrollTracker","couponCode","users","$timeout","$log","nodes","DAY_IN_MILLISECONDS","optimizely","userTrials","googleTagManager",function(a,d,b,c,e,f,g,h,i,j,k,l,m,p,n,r,q){var t=function(a){return"card_declined"===a.code?"Your card was declined. Please try again. If this issue persists, please contact payment-support@udacity.com.":
"processing_error"===a.code?"An error occurred while processing your card. Please try again.If this issue persists, please contact payment-support@udacity.com.":a.code?a.message:"An error occurred while processing your card. Please check your information and try again. If this issue persists, please contact payment-support@udacity.com."},u=function(a){return a&&_.map(a._course_groups,function(a){return a.course_ref&&a.course_ref.key})},v=function(b,c){c=c||100;return 6E4>c?j.assignTutor("me",b,{timeout:3E3}).then(function(a){if(a&&
a.coach)return a.coach.coach_profile},function(){return k(function(){v(b,2*c)},c)}):a.reject()},s=function(b,d){var e={product_keys:d.productKeys};b&&b.id&&(e.stripe_token=b.id);d.coupon&&d.coupon.valid&&(e.coupon_id=d.coupon.key);return c.post("/customers/me/purchases",e).then(function(a){return a.data.purchase},function(b){d.generalPaymentFormError=b.data.error?t(b.data):"We are having difficulties processing your request. If this error keeps appearing please contact payment-support@udacity.com.";
b.data.was_charged&&alert("Error - your card was charged successfully but an error occured.Please contact us at payment-support@udacity.com immediately and we'll get this sorted out. Your spot is reserved. Please do NOT pay again.");return a.reject(b)})};return[{label:"Checkout",view:"/templates/angular/payment/payment_form.html",onStart:function(b,e){var h=[f.get(e.productKeys[0]),g.get("me")];if(i){var j=c.get("/coupons/"+i+"/compute_discount",{product_key:e.productKeys[0]}),j=j.then(function(a){e.coupon=
a.data.coupon;a.data.coupon.valid&&(e.coupon.discounted_price=a.data.result)},function(){e.coupon={valid:!1};return null});h.push(j)}a.all(h).then(function(a){e.product=a[0];var b=_.first(e.product._course_groups).course_ref.key;m.get(b).then(function(a){var b=a.catalog_entry._image?a.catalog_entry._image.serving_url:null;e.confirmationStepLabel={Degree:"Start nanodegree",Course:"Start course"}[a._semantic_type];e.course={imageUrl:b,isNanodegree:"Degree"===a._semantic_type}});b=e.product.trial_period_days;
e.inTrialPeriod=0<b;e.trialPeriodStarts=new Date(Date.now()+b*p);e.customer=a[1];e.customerCard=d.getDefaultCard(e.customer);e.cardIsLoaded=!0;e.uriEncodedCourseKey=window.encodeURIComponent(u(e.product));n.activate();q.pushTrackingEvent("checkoutStart",{productName:e.product.name,productPrice:e.product.amount})})},onJump:function(a){return a.paymentConfirmed?!1:!a.paymentConfirmed},onSubmit:function(b,c){if(c.customerCard)return s(!1,c);var e=b.creditCard||{},f=d.checkValidity(e);c.creditCardErrors=
f.errorText;if(!f.valid)return!1;f=(c.product&&c.product.name)+", "+u(c.product);return d.createPaymentToken(f,e).then(function(a){return s(a,c)},function(b){c.generalPaymentFormError=t(b.error);return a.reject(b)})}},{getLabel:function(a){return a.confirmationStepLabel},view:"/templates/angular/payment/payment_confirmation.html",onStart:function(a,b){b.paymentConfirmed=!0;b.payment=a;b.product.trial_period_days&&(0<b.product.trial_period_days&&!b.course.isNanodegree)&&v(u(b.product)[0]).then(function(a){b.coach=
a});n.activate();window.optimizely&&r.enroll("trial-screener",window.optimizely.data.state.variationNamesMap["2025731129"]);h.track(u(b.product)+"paid");var c=b.product&&(b.product.amount||0)/100,d=null;try{d=_.find(a.customer.subscriptions,function(a){return a.plan.id===b.product.key}).id}catch(e){l.error("Failed to get Transaction Id",e)}_gaq.push(["_addTrans",d,"Udacity",c,"0.00","0.00","Mountain View","California","USA"]);_gaq.push(["_addItem",d,"DD44",b.product&&b.product.name,u(b.product),c,
"1"]);_gaq.push(["_trackTrans"]);window.dataLayer.push({transactionVal:c,transactionOrderId:d,transactionPromoCode:i,event:"CompletedOrder"})}}]}]);angular.module("payment").factory("paymentFlow",["$q","paymentState","$location",function(a,d,b){return{begin:function(a){a=d.startFlow(a);if(a.onStart)a.onStart(null,d.getCurrentFlowData());b.path("/"+d.getCurrentStep().number.toString())},submitStep:function(c){var e=a.defer();(c=d.getCurrentStep().onSubmit(c,d.getCurrentFlowData()))?a.when(c).then(function(a){var c=d.goToNextStep();if(c.onStart)c.onStart(a,d.getCurrentFlowData());e.resolve();b.path("/"+c.number.toString())},function(){e.resolve()}):
...
h.valid?(g={reason:a.reason},e.all(_.map(f,function(d){d=c("slugify")(d);return b.addToEmailList(a.name,a.email,"nanodegree-interest-"+d,g)})).then(function(){a.submitted=!0;a.postError=!1},function(){a.postError=!0})["finally"](function(){a.isWorking=!1})):(a.isWorking=!1,a.errorList=h.errorText)};a.submit=function(b){b=_.filter(_.keys(b),function(a){return b[a]});a.submitList(b)};a.mainPageSocial={twitter:{text:"Get a job I love with a credential that fits into my life? Yes. Udacity nanodegrees, built by industry.",
url:"https://www.udacity.com/nanodegrees"},facebook:{name:"Introducing Udacity Nanodegrees",link:"https://www.udacity.com/nanodegrees",caption:"Industry credentials for today's jobs in tech",description:"Stand out with tech skills that matter. Learn from the very best in industry. Study smart without leaving your current job."},gplus:{link:"https://www.udacity.com/nanodegrees"}};_.each(["att","google","Cloudera","salesforcecorp","autodesk"],function(b){f.get(b).then(function(c){c&&c._image&&(a.partnerImages[b]=
c._image.serving_url)})})}]);angular.module("staticPages").controller("organizationPage",["$scope","validator","users",function(a,d,b){a.submitted=!1;a.errorList=null;a.postError=!1;a.isWorking=!1;a.showNoteField=!1;a.toggleNote=function(){a.showNoteField=!a.showNoteField};a.submit=function(){a.isWorking=!0;a.errorList=null;a.postError=!1;a.submitted=!1;var c;c=d.check({firstName:{pretty:"your first name",value:a.firstName,validators:[{type:"required"}]},lastName:{pretty:"your last name",value:a.lastName,validators:[{type:"required"}]},
companyName:{pretty:"your company name",value:a.companyName,validators:[{type:"required"}]},email:{pretty:"your email address",value:a.email,validators:[{type:"required",chained:[{type:"email"}]}]}});c.valid?(c={company_name:a.companyName,job_title:a.jobTitle,note:a.note},b.addToEmailList(a.firstName+" "+a.lastName,a.email,"enterprise-contacts",c).then(function(){a.submitted=!0;a.postError=!1;a.isWorking=!1},function(){a.postError=!0;a.isWorking=!1})):(a.isWorking=!1,a.errorList=c.errorText)}}]);angular.module("staticPages").controller("proctoredExamPage",["$scope","exams","$window",function(a,d,b){a.passedPasswordCheck=!1;a.isFetching=!1;a.convertTime=function(a){if(!a||"number"!==typeof a)return"No time has been set";var b=Math.floor(a/60),d=Math.floor(a/3600),g=Math.floor(a%3600/60),h=Math.floor(a%60),i=[];1===d&&(i+=d+" hour ");1<d&&(i+=d+" hours ");1===g&&(i+=g+" minute ");1<g&&(i+=g+" minutes ");1===h&&(i+=h+" second ");1<h&&(i+=h+" seconds ");return i=1===b?i+"(1 minute)":i+("("+Math.floor(a/
...
g.pending[e]&&g.pending[e].readyNotification(g.run);if(null!==b)g.pending=_.without(g.pending,b),b["finally"](g.run),g.running.push(b),d(b.start);else break}}};return g};c=a.make;return a}]);angular.module("viewer").constant("badWords","fuck bitch shit cunt asshole dick sex pussy bastard".split(" "));angular.module("viewer").directive("chatTest",["lesson","currentUser","libraryLoader","$timeout","$document","nodeUtility","cacheVersion","badWords",function(a,d,b,c,e,f,g,h){return{scope:!0,templateUrl:"/templates/temp/chat_test.html?"+g,link:function(e,g){var k=null,l=d.get("nickname")||d.get("first_name");e.showChat=!1;e.showUsers=!1;e.expletiveUsed=!1;e.toggleUsers=null;e.toggleChat=null;e.getNumUsers=null;e.sendChat=null;e.checkForExpletive=null;e.userToColor=null;e.pingUser=null;e.revealChat=
!1;e.startCountingUnreadMessages=!0;e.numberOfUnreadMessages=0;e.showNumberOfUnreadMessages=function(){return e.startCountingUnreadMessages&&0<e.numberOfUnreadMessages};var m=_.throttle(function(){c(angular.noop)},1E3),p=function(a){a.on("mousewheel",function(a){var b=a.originalEvent;this.scrollTop+=30*(0>(b.wheelDelta||-b.detail)?1:-1);a.preventDefault()})},n=function(){g.find(".chat-history").scrollTop(g.find(".chat-history")[0].scrollHeight)};p(g.find(".chat-history"));p(g.find(".chat-user-list"));
a.addEventListener("lessonChange",function(c){d.userIsLoggedIn()&&b.loadLibraries(["https://cdn.firebase.com/js/client/1.1.2/firebase.js"]).then(function(){var b=c.lesson.key;k&&k.off();var g=new Firebase("https://udacity.firebaseio.com");k=g.child("node-"+b);var j=k.child("active-users"),p=d.get("key");e.currentUsers={};j.on("value",function(a){e.currentUsers=a.val();m()});g.child("enabled").on("value",function(a){a.val()?(Firebase.goOnline(),e.revealChat=!0):(Firebase.goOffline(),e.revealChat=!1)});
a.addEventListener("courseChange",function(b){var c=_.findWhere(d.get("_enrollments"),{node_key:b.course.key});e.isPaidStudent=f.isCurrentEnrolled(c,b.course);g.child("courses").once("value",function(c){if(-1===_.values(c.val()).indexOf(b.course.key))Firebase.goOffline(),e.revealChat=!1;else{Firebase.goOnline();e.revealChat=!0;var d=j.push({name:l,userKey:p});d.onDisconnect().remove();a.addEventListener("lessonChange",function(){d.remove()},{removeOnDestructionOf:e})}})},{replayLast:!0,removeOnDestructionOf:e});
var s=[];e.toggleUsers=function(){e.showChat?e.showUsers=!e.showUsers:e.toggleChat()};e.toggleChat=function(){e.showChat=!e.showChat;e.startCountingUnreadMessages=!e.startCountingUnreadMessages;e.numberOfUnreadMessages=0;e.showChat&&_.defer(function(){n()})};e.getNumUsers=function(){return _.isObject(e.currentUsers)?_.keys(e.currentUsers).length:0};e.sendChat=function(){if(e.chatMessage){var a,b=e.chatMessage;a=_.find(h,function(a){return-1<b.toLowerCase().indexOf(a)});e.expletiveUsed=a;e.expletiveUsed||
(k.push({sender:l,text:e.chatMessage,date:Firebase.ServerValue.TIMESTAMP}),e.chatMessage="")}};e.getUsernameColor=function(a){var b="#000000 #303030 #4E4E4E #666666 #767676 #999999 #B3B3B3 #294860 #307699 #1199C3 #8DC5D8 #F6A926 #F08C35 #E29791 #90CC83".split(" "),a=a.charCodeAt(a.length-1)%b.length;return b[a]};e.pingUser=function(a){e.chatMessage="@"+a.name};b=k.limit(100);b.once("value",function(a){e.numberOfUnreadMessages-=_.values(a.val()).length});b.on("child_added",function(a){s.push(a.val());
e.startCountingUnreadMessages&&(e.numberOfUnreadMessages+=1);e.chatHistory=s;m();_.defer(function(){n()})});e.lessonTitle=c.lesson.title})},{replayLast:!0,removeOnDestructionOf:e})}}}]);angular.module("user").factory("currentUser",["$q","$rootScope","users","basicUser","gaqHelper","nodes","nodeUtility","userUtility",function(a,d,b,c,e,f,g,h){var i=angular.copy(c),j={get:function(a){return i[a]},getUser:function(){return i},getFullName:function(){return h.getFullName(i)},getEmail:function(){return h.getEmail(i)},setUser:function(a){angular.copy(angular.copy(a),i)},fetchFullUser:function(){return b.get("me").then(function(a){j.setUser(a);return a})},userIsLoggedIn:function(){return i._registered},
isEnrolledIn:function(a){return _.some(i._enrollments,function(b){return b.node_key===a&&"enrolled"===b.state})},isEnrolledForCreditIn:function(a){var b=["151101088","150207572","151148782","151059885","151254701"];return void 0!==_.find(i._enrollments,function(c){var d=_.pluck(c.group_refs,"key");return c.node_key===a&&"enrolled"===c.state&&0<_.intersection(d,b).length})},isCourseEmailSubscribed:function(a){return 0<_.filter(i._enrollments,function(b){return b.node_key===a&&b.email_ok}).length},
enroll:function(a,c,f){c=c||"enrolled";return b.setEnrollments("me",[a],c).then(function(a){i._enrollments=i._enrollments||[];_.each(a,function(a){var b=_.find(i._enrollments,function(b){return b.node_key===a.node_key});b?i._enrollments[_.indexOf(i._enrollments,b)]=a:i._enrollments.push(a)});if(1===a.length){d.$broadcast("modifiedEnrollment",a);var b=c.slice(0,1).toUpperCase()+c.slice(1,-2),b=e.pushTrackingEvent("Enrollment",b,a[0].node_key);return f?b.then(function(){return a},function(){console.warn("Failed to push enrollment to Google Analytics");
return a}):a}return a})},changeEnrollmentSettings:function(a,c){return b.changeEnrollmentSettings(a,"me",c)},getEnrollmentsWithState:function(a){return _.filter(i._enrollments,function(b){return b.state===a})}};return j}]);angular.module("user").directive("userMenu",["currentUser","session",function(a,d){return{restrict:"A",controller:["$scope",function(){}],link:function(b){b.isLoggedIn=a.userIsLoggedIn;b.user=a.getUser;b.logOut=function(){d.terminate().then(function(){window.location.reload()})}}}}]);angular.module("user").factory("userUtility",[function(){return{getFullName:function(a){if(a)return a.first_name&&a.last_name?a.first_name+" "+a.last_name:a.first_name||a.last_name},getEmail:function(a){return a.email&&a.email.address}}}]);angular.module("utility").factory("adrollTracker",["$q","$timeout",function(a,d){return{track:function(b){var c={},e=a.defer();b&&(c.adroll_segments=b);try{window.__adroll.record_user(c)}catch(f){}d(function(){e.resolve(!0)},250);return e.promise}}}]);angular.module("utility").directive("animatedToggle",function(){return{restrict:"A",link:function(a,d,b){b.toggleTarget||console.error("You must provide a toggle-target with a selector for the child element to toggle");b.toggler||console.error("You must provide an element to trigger the toggle");var c=d.find(b.toggleTarget),a=d.find(b.toggler);c||console.error("Element to toggle ("+b.toggleTarget+") not found!");a||console.error("Element to trigger toggle ("+b.toggler+") not found!");$(a).on("click",
function(){$(c).toggle("fast")});window.location.hash.substring(1)===a.attr("id")?$(c).show():$(c).hide()}}});angular.module("utility").factory("callbackList",function(){return{create:function(){var a=[],d,b=!1,c={add:function(e,f,g){a.push(e);b&&f?(e(d),g&&c.remove(e)):g&&(e._removeOnFire=!0);return c},remove:function(b){for(var d=a.length,g=0;g<d;g++)a[g]===b&&(a.splice(g,1),g-=1);return c},fire:function(e){var f,g=_.clone(a),h=g.length;for(f=0;f<h;f++)try{g[f](e)}catch(i){console.error("Exception encountered in callback:"+i.message),console.error(g[f])}d=e;b=!0;for(f=0;f<a.length;f++)!0===a[f]._removeOnFire&&
...
angular.module("utility").factory("googleHelper",["$timeout","$q","$location","libraryLoader",function(a,d,b,c){var e,f,g={client_id:"72069832843-ji15b2fqekfntf5q1k9q0pboieao8hfa.apps.googleusercontent.com",scope:"https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email"},h={_init:function(){e=d.defer();f=!1;g.client_id="127.0.0.1"===b.host()?"72069832843-8m1i2jll4frcqge66a2be0utlbv8ij1h.apps.googleusercontent.com":"72069832843-ji15b2fqekfntf5q1k9q0pboieao8hfa.apps.googleusercontent.com"},
_consts:function(){return{PROD_APP_ID:"72069832843-ji15b2fqekfntf5q1k9q0pboieao8hfa.apps.googleusercontent.com",LOCAL_APP_ID:"72069832843-8m1i2jll4frcqge66a2be0utlbv8ij1h.apps.googleusercontent.com",CURRENT_APP_ID:g.client_id}},getConfig:function(){g.foo="bar";return _.clone(g)},loadApi:function(){!0!==f&&(window.__GFDGoogle||(window.__GFDGoogle=function(){window.gapi.auth.init(function(){a(function(){f=!0;e.resolve(!0)})})}),c.loadLibraries(["https://apis.google.com/js/client.js?onload=__GFDGoogle"]).then(function(){},
function(){console.warn("Google libraries failed to load!");e.reject("Google libraries failed to load!")}));return e.promise}};h._init();return h}]);angular.module("utility").directive("googlePlusShare",["facebook","$location",function(a,d){return{restrict:"A",scope:{googlePlusShare:"="},template:'<a href="" data-ng-class="classes" data-ng-click="share()" ng-transclude></a>',transclude:!0,replace:!0,link:function(a,c,e){a.classes=e["class"];a.share=function(){window.open("https://plus.google.com/share?url="+window.encodeURIComponent(a.googlePlusShare.link||d.absUrl()))}}}}]);angular.module("utility").factory("normalizedSocialService",["facebook","google",function(a,d){return{normalizeAccountService:function(b){var c={},e=d;c.login=d.getToken;"facebook"===b&&(e=a,c.login=a.getAuthResponse);c.getAccount=e.getMeResponse;return c},normalizeAccount:function(a,c){"google"===a&&(c.firstName=c.given_name,c.lastName=c.family_name);"facebook"===a&&(c.firstName=c.first_name,c.lastName=c.last_name);return c},createSessionData:function(a,c){var d={};"google"===a?d.google={token:c.code}:
...
screen.colorDepth;return b.screenColorDepth};return a.eventEmission({browserSize:p,browserType:i,browserVersion:j,cookiesEnabled:l,flashEnabled:m,os:k,screenSize:n,screenColorDepth:r,ua:function(){return b.ua},language:function(){return b.lang},flushCache:c,browserStats:function(a){return{browser:i(a),version:j(a),os:k(a)}},getAllTech:function(a){a=!!a;i(a);j(a);k(a);l(a);m(a);p(a);n(a);r(a);return b}},["browserDetected"])}]);angular.module("utility").factory("userTrials",["mixin","currentUser","recordActivity","userTrialsHelper",function(a,d,b,c){var e={enroll:function(a,g){if("string"!==typeof a||"string"!==typeof g||""===a.trim()||""===g.trim())console.error("Trial key and treatment must both be non-empty strings.");else{var h=c.getEnrollments(d.get("key"));h[a]=g;c.saveEnrollments(d.get("key"),h);b.experimentAssignment(a,g);e.emitEvent("enrollment",{trial:a,treatment:g})}},unenroll:function(a){if("string"!==typeof a||
""===a.trim())console.error("Trial key must be a non-empty string.");else{var b=c.getEnrollments(d.get("key")),h=b[a]||null;null!==h?(delete b[a],c.saveEnrollments(d.get("key"),b),e.emitEvent("unenrollment",{trial:a,treatment:h})):console.warn("Tried to unenroll from "+a+" but wasn't enrolled in it!")}},getTreatment:function(a){return c.getEnrollments(d.get("key"))[a]||null},getOrEnroll:function(a,b,c){c=_.isArray(c)?c:[];if("string"!==typeof a||""===a.trim())return console.error("trialKey must be a non-empty string."),
...
!0;b.enroll(c).then(function(){a.enrollRequestPending=!1;d.confirm()})}}]);angular.module("viewer").controller("imageQuizPanel",["$scope","lesson","imageQuiz","tidbits","viewerSettings",function(a,d,b,c){a.attempted=!1;a.correctlyAnswered=!1;a.status="unsubmitted";a.quizReturn=null;a.tidbitViewerMode="quiz-only";a.isTidbitAvailable=function(a){return a.completed||c.isTidbitRelevant(a,a.tidbit_ref.containingExercise.quiz_ref.binCodes)};a.isTidbitRelevant=function(b){return!a.isPlaying(b.tidbit_ref)&&a.quizReturn&&c.isTidbitRelevant(b,a.quizReturn.binCodes,!0)};a.isPlaying=
function(b){return a.tidbit&&b&&a.tidbit.key===b.key};a.submitQuiz=function(){b.submit()};a.getSubmitButtonLabel=function(){return"processing"===a.status?"Processing":"Submit Answer"};d.addEventListener("morselChange",function(){a.quizReturn=null;a.attempted=!1;a.correctlyAnswered=!1;a.status="unsubmitted"},{replayLast:!0,removeOnDestructionOf:a});d.addEventListener("tidbitChange",function(b){a.tidbitViewerMode=c.getTidbitViewerMode(b.tidbit)},{replayLast:!0,removeOnDestructionOf:a});b.addEventListener("submitting",
function(){a.status="processing";a.quizReturn=null});b.addEventListener("correct",function(b){a.attempted=!0;a.status="correct";a.correctlyAnswered=!0;a.quizReturn={status:"correct",text:b.comment,binCodes:b.binCodes}},{removeOnDestructionOf:a}).addEventListener("incorrect",function(b){a.attempted=!0;a.status="incorrect";a.quizReturn={status:"incorrect",text:b.comment,binCodes:b.binCodes}},{removeOnDestructionOf:a}).addEventListener("error",function(b){a.attempted=!0;a.status="error";a.quizReturn=
{status:"error",text:b.comment}},{removeOnDestructionOf:a}).addEventListener("recorded",function(b){a.status="recorded";a.quizReturn={status:"recorded",text:b.comment}})}]);angular.module("viewer").controller("programmingQuizOutputPanel",["$scope","lesson","programmingQuiz","tidbits",function(a,d,b,c){a.status="unsubmitted";a.stdout=null;a.stderr=null;a.images=null;a.ready=!1;a.run=function(){b.run();a.status="processing";a.stdout=null;a.stderr=null;a.images=null};a.getSubmitButtonLabel=function(){return"processing"===a.status?"Processing":"Test Run"};a.reset=function(){window.confirm("Are you sure you want to reset to the original assignment stub?")&&b.reset()};d.addEventListener("morselChange",
...
{removeOnDestructionOf:a});b.addEventListener("runError",function(){a.stderr="The server encountered an error. Please try running again.";a.status="error"},{removeOnDestructionOf:a});b.addEventListener("ready",function(){a.ready=!0},{removeOnDestructionOf:a})}]);angular.module("viewer").controller("programmingQuizPanel",["$scope","lesson","programmingQuiz","tidbits",function(a,d,b,c){a.status="unsubmitted";a.quizReturn=null;a.attempted=!1;a.answeredCorrectly=!1;a.submitProgrammingQuiz=function(){b.submit();a.status="processing";a.quizReturn=null};a.getSubmitButtonLabel=function(){return"processing"===a.status?"Processing":"Submit"};a.isTidbitAvailable=function(a){return a.completed||c.isTidbitRelevant(a,a.tidbit_ref.containingExercise.quiz_ref.binCodes)};
a.isTidbitRelevant=function(b){return!a.isPlaying(b.tidbit_ref)&&a.quizReturn&&c.isTidbitRelevant(b,a.quizReturn.binCodes,!0)};a.isPlaying=function(b){return a.tidbit&&b&&a.tidbit.key===b.key};d.addEventListener("morselChange",function(){a.status="unsubmitted";a.quizReturn=null;a.attempted=!1;a.answeredCorrectly=!1},{replayLast:!0,removeOnDestructionOf:a});d.addEventListener("tidbitChange",function(b){a.tidbitViewerMode=c.getTidbitViewerMode(b.tidbit)},{replayLast:!0,removeOnDestructionOf:a});b.addEventListener("evaluated",
function(b){a.status="evaluated";a.attempted=!0;b=b.result;a.quizReturn={text:b.comment,binCodes:b.bin_codes};!0===b.passed?(a.quizReturn.status="correct",a.answeredCorrectly=!0):a.quizReturn.status=!1===b.passed?"incorrect":"recorded"},{removeOnDestructionOf:a});b.addEventListener("evaluationError",function(){a.status="error";a.attempted=!0;a.quizReturn={status:"incorrect",text:"There was an error grading your quiz, please try submitting again."}},{removeOnDestructionOf:a});b.addEventListener("submitting",
function(){a.status="processing";a.quizReturn=null})}]);angular.module("viewer").controller("studentGoals",["$scope","firebaseGoals","studentGoals","users","currentUser","$routeParams","dateTime","userTrials","recordActivity","libraryLoader","cookieJar","lesson","$timeout",function(a,d,b,c,e,f,g,h,i,j,k,l,m){a.goal=b.getCurrent;a.goalKey=b.getCurrentKey;a.tutor=null;a.currentTime=g.getCurrentAsUTC;a.currentLesson=b.currentLesson;a.daysUntilDue=b.daysUntilCurrentGoalDue;a.checkGoal=function(){b.checkGoal(a.goal())};a.getGoalState=function(){var b=a.goal();
return"loading"===b?"loading":!b||!b.state?null:b.state.complete?"complete":b.target_time<g.getCurrentAsUTC()?"behind":"ongoing"};a.shown=!1;var p=function(){k.set("stGlDd",g.getCurrent().getTime()+432E5)};a.showGoal=function(){a.shown||i.observation("student_goal_open",1,{});a.shown=!a.shown};a.emailTutor=function(){i.observation("student_goal_coach_email",1,{})};d=function(a){a=1*a.slice(-1);return 4>a?"experimental":7>a?"control":"excluded"};"experimental"===(e.userIsLoggedIn()?h.getOrEnroll("student_goals",
d,[e.get("key")]):"excluded")&&c.getTutors("me",{node_key:f.courseKey}).then(function(c){if(_.isArray(c.tutor_assignments)){var d=_.find(c.tutor_assignments,function(a){return a.class_ref===f.courseKey});d&&j.loadLibraries(["//cdn.firebase.com/js/client/1.0.19/firebase.js"]).then(function(){b.init(e.get("key"),f.courseKey);a.tutor=c.accounts[d.tutor_account_ref];m(function(){if(!k.exists("stGlDd")||k.get("stGlDd")<g.getCurrent().getTime())a.shown=!0;p();l.addEventListener("morselChange",p)},1)})}})}]);angular.module("viewer").controller("videoPlayer",["$scope","lesson","youtubeVideoPlayer","viewerSettings",function(a,d,b,c){var e=!1;a.pauseVideo=function(){e&&b.pauseVideo()};a.obliterateVideo=function(){e&&b.destroyVideo()};a.playVideo=function(a,d){e?b.loadVideo(a.youtube_id,0):(b.attach(d.get(0),a.youtube_id,{autoPlay:c.get("autoPlay")?1:0}),e=!0)};b.addEventListener("apiReady",function(){d.addEventListener("pendingMorselChange",a.pauseVideo,{removeOnDestructionOf:a}).addEventListener("pendingLessonChange",
...
ma006:["We recommend having a pencil and paper handy for this class."],ma008:["We recommend having a pencil and paper handy for this class."],st095:["We recommend having a pencil and paper handy for this class.",'Want to read about some fascinating real-world statistics? Check out Dan Ariely\'s book "Predictably Irrational"!']});angular.module("viewer").constant("videoViewedTimeThreshold",3).controller("viewerPage",["$scope","lesson","$location","$routeParams","lessonActivityTracker","$timeout","videoViewedTimeThreshold","youtubeVideoPlayer","viewerSettings","cacheVersion","loadingMessages","lessonPrefetcher","tags","libraryLoader","viewerPartialMap","examMode","techDetect","api","sessionLapsed","modal","currentUser","nodeUtility","gaqHelper","canEditNotes","guidedTour","users","qualaroo","$log",function(a,d,b,c,e,f,g,h,
i,j,k,l,m,p,n,r,q,t,u,v,s,x,D,E,H,I,F,G){function A(){var b;b=_.without(_.union(k.general,k[w]),null,void 0,"");a.viewerLoadingMessage=b[_.random(b.length-1)];a.isViewerLoading=!0}function z(a,b,c){if(a){var d=n[a.model];if(d){if(!c||d.extension)return"/templates/angular/viewer/partials/"+d.prefix+b+"?"+j}else console.error("Unrecognized morsel type "+a.model)}else if(!c)return"/templates/angular/viewer/partials/loading"+b+"?"+j}function B(a){f.cancel(y);("Video"===a.model||"SketchVideo"===a.model)&&
h.addEventListener("videoPlay",function(){f.cancel(y);y=f(C(a.key),1E3*g,!1)},{removeAfterFired:!0})}function C(a){return function(){if(h.getCurrentTime()>=g){var b=h.getCurrentTime();h.emitEvent("videoPause",b);h.emitEvent("videoPlay",b+1);d.markMorselAsCompleted(a)}else y=f(C(a),500,!1)}}a.modalsUrl="/templates/viewer/partials/viewer_modals.html?"+j;a.getCoachServicesUrl=function(){if(a.course)return"/conditional/tutoring?course_id="+window.encodeURIComponent(a.course.key)+"&cache_bust="+j};a.userIsLoggedIn=
s.userIsLoggedIn();a.canEditNotes=E;a.course=null;a.lessons=null;a.lesson=null;a.morsels=null;a.morsel=null;a.tidbit=null;var w=b.path().match("/"+m.course+"([^/]+)"),w=w?w[1]:null;a.courseKeyFromUrl=w;w||(window.location.href="/");t.addEventListener("sessionExpired",function(){window.location.href="/account/auth#!/signin?next=%2Fcourse%2Fviewer%23!"+encodeURIComponent(b.path())});u&&(window.location.href="/account/auth#!/signin?next=%2Fcourse%2Fviewer%23!"+encodeURIComponent(b.path()));d.addEventListener("lessonPermissionDenied",
function(){window.location.href="/course/"+w});d.addEventListener("courseChange",function(a){if((!a.lessons||0===a.lessons.length)&&!a.lastLessonVisited&&!c.lessonKey)window.location.href="/course/"+w}).addEventListener("coursePermissionDenied",function(){c.lessonKey||(window.location.href="/course/"+w)});d.addEventListener("lessonChange",function(a){if(!a.morsels||0===a.morsels.length)window.location.href="/course/"+w});a.isViewerLoading=!0;d.addEventListener("courseChange",function(){p.loadLibraries(["codemirror",
"mathquill"]).then(function(){},function(){G.error("Classroom failed to load a required library");alert("Failed to load some required parts of the course! Please refresh the page. If this issue persists, please contact support@udacity.com. Thanks!")})}).addEventListener("morselChange",function(){a.isViewerLoading=!1});d.addEventListener("courseChange",function(b){a.course=b.course;a.lessons=b.lessons;a.enrollment=_.find(s.get("_enrollments"),function(a){return a.node_key===b.course.key});a.premiumAccess=
x.hasPermissionTo(a.course,"view-paid-supplemental-media")||a.enrollment&&(x.isCurrentEnrolled(a.enrollment,b.course)||x.isGraduated(a.enrollment,b.course));F.set({isPaid:a.premiumAccess?"yes":"no"})},{replayLast:!0,removeOnDestructionOf:a}).addEventListener("lessonChange",function(b){a.lesson=b.lesson;a.morsels=b.morsels},{replayLast:!0,removeOnDestructionOf:a}).addEventListener("morselChange",function(b){a.morsel=b;B(b)},{replayLast:!0}).addEventListener("tidbitChange",function(b){(a.tidbit=b.tidbit)&&
B(b.tidbit)},{replayLast:!0});d.addEventListener("pendingLessonChange",function(){a.morsels=null;a.morsel=null;a.tidbit=null});a.$on("$routeChangeSuccess",function(b,f,g){if(b=!c.morselKey)if(!g||!f)b=!1;else{var h=g.pathParams,f=f.pathParams;if(_.keys(h).length===_.keys(f).length)b=!1;else{var i=!0;_.each(f,function(a,b){h[b]!==a&&(i=!1)});b=i}}b&&window.history.back();c.courseKey&&c.courseKey!==w&&window.location.reload();g&&D.pushPageviewEvent();if((null===a.course||a.course.key!==c.courseKey)&&
"none"!==c.courseKey)A(),d.addEventListener("courseChange",function(b){c.lessonKey||(b.lastLessonVisited?a.goToLesson(b.lastLessonVisited.key):a.goToLesson(b.lessons[0].key))},{removeAfterFired:!0}),d.changeCourse(c.courseKey);if((null===a.lesson||a.lesson.key!==c.lessonKey)&&c.lessonKey)A(),d.addEventListener("lessonChange",function(b){c.morselKey||(b.lastMorselVisited?a.goToMorsel(b.lastMorselVisited):a.goToMorsel(b.morsels[0]))},{removeAfterFired:!0}),d.changeLesson(c.lessonKey);if((null===a.morsel||
a.morsel.key!==c.morselKey)&&c.morselKey)e.logNodeVisit("morsel"),a.lesson&&a.lesson.key===c.lessonKey?d.changeMorsel(c.morselKey):d.addEventListener("lessonChange",function(){d.changeMorsel(c.morselKey)},{removeAfterFired:!0});if(null===a.tidbit||a.tidbit.key!==c.tidbitKey)c.tidbitKey&&e.logNodeVisit("tidbit"),a.morsel&&a.morsel.key===c.morselKey?d.changeTidbit(c.tidbitKey):d.addEventListener("morselChange",function(){d.changeTidbit(c.tidbitKey)},{removeAfterFired:!0})});a.alert=function(a){alert(a)};
...
j.encodeURIComponent(e.key)+"&start="+j.encodeURIComponent(i.absUrl())},function(){c.showBanner=!1});l()}else c.showBanner=!1});c.goToPurchase=function(a){j.location.href="/checkout#!/0?products="+j.encodeURIComponent(_.first(a.catalog_entry.paid_class.class_product_refs).key)};c.cancelBanner=function(){d.set("cancel-side-panel-upsell",!0);c.showBanner=!1}}}}]);angular.module("viewer").directive("studentGoals",["cacheVersion","$document",function(a,d){return{restrict:"A",templateUrl:"/templates/viewer/partials/student_goals.html?"+a,controller:"studentGoals",link:function(a,c){var e=function(d){a.shown&&(!d||!c||!c[0].contains(d.target))&&a.$apply(function(){a.shown=!1})};d.on("click",e);a.$on("destroy",function(){d.off("click",e)})}}}]);angular.module("viewer").directive("supplementalMaterialsList",["cacheVersion",function(a){return{templateUrl:"/templates/viewer/partials/supplemental_materials_list.html?"+a}}]);angular.module("viewer").directive("viewerDiscussions",["forumService","lesson","$http","cacheVersion","siteExperience",function(a,d,b,c,e){return{restrict:"A",templateUrl:"/templates/viewer/partials/viewer_discussions.html?"+c,controller:["$scope","$attrs","examMode",function(c,g,h){c.examMode=h;c.postsStartIndex=0;c.postsEndIndex=0;c.limitedAccess=e.limitedAccess;c.affiliateExperienceId=e.affiliateExperienceId;var i=g.numPerPage,j=function(b,d){if(b&&d&&!c.limitedAccess)return c.seeAllCoursePostsUrl=
"http://forums.udacity.com/tags/"+b.key+"/#"+b.key,c.askAQuestionUrl="http://forums.udacity.com/questions/ask/?tag="+(d.containingExercise?d.containingExercise.key:d.key)+"#"+b.key,a.getPosts(d.containingExercise?d.containingExercise.key:d.key,0,i,b).then(function(a){c.posts=a;c.postsStartIndex=1+0*i;c.postsEndIndex=c.posts.length+0*i})};d.addEventListener("courseChange",function(a){var e=a.course.key;c.course=a.course;angular.isString(e)&&"nd"===e.slice(e.length-2)?c.isNanodegreeAssociatedCourse=
!0:"Degree"===a.course._semantic_type?c.isNanodegree=!0:"design101"===a.course.key?d.addEventListener("morselChange",function(a){if(a){c.posts=null;var a=window.encodeURIComponent(a.key),d=c.lesson.title,d=d.toLowerCase().replace(/[\?\!\:\&\,\(\)\^]/g,"").replace(" - ","-").replace(/\s+/g,"-").replace(/_/g,"-");b.get("https://design101-forum.udacity.com/subcategory/"+a+".json?per_page=1").then(function(a){a.data.topic_list&&(c.posts=_.map(a.data.topic_list.topics,function(b){var c=null,d=_.find(a.data.users,
function(a){if(b.posters[0])return a.id===b.posters[0].user_id});d&&(c=d.avatar_template);return{date:b.bumped_at,title:b.fancy_title,href:"https://design101-forum.udacity.com/t/"+b.slug+"/"+b.id,userPicUrl:c}}))});a="https://design101-forum.udacity.com/category/"+window.encodeURIComponent(d);c.askAQuestionUrl=a;c.seeAllCoursePostsUrl=a}},{replayLast:!0}):"ud585"===a.course.key?(a=a.course.forum_slug,e=c.lesson.forum_slug,c.posts=null,c.seeAllLessonPostsUrl="http://swift-forums.udacity.com/c/"+a+
"/"+e,c.askAQuestionUrl="http://swift-forums.udacity.com/c/"+a+"/"+e+"/create",c.isDiscourseSecondPilot=!0):(d.addEventListener("morselChange",function(a){c.morsel=a;c.posts=void 0;j(c.course,c.morsel)},{replayLast:!0}),j(c.course,c.morsel))},{replayLast:!0,removeAfterFired:!0})}]}}]);angular.module("viewer").directive("viewerFeedback",["validator","recordActivity","cacheVersion","lesson","lessonContentContext","techDetect","youtubeVideoPlayer",function(a,d,b,c,e,f,g){return{templateUrl:"/templates/viewer/partials/viewer_feedback.html?"+b,controller:["$scope","modal",function(b,c){b.form={feedbackReason:{value:null,validators:[{type:"required",failMsg:"Please select the type of feedback you wish to give."}]},feedbackExplanation:{value:null,validators:[{type:"javascript",args:[function(a,
...
code:"confusingContent",explanation:"e.g. course material is not explained correctly"}],k=[{name:"Instructions are unclear",code:"instructionsUnclear"},{name:"Inappropriate question",code:"inappropriateQuestion",explanation:"e.g. question is too easy/difficult"},{name:"Correct answer is not accepted",code:"correctAnswerNotAccepted"},{name:"Grading feedback is unhelpful",code:"gradingFeedbackUnhelpful"},{name:"Answer video is unclear",code:"answerVideoUnclear"}];b.showFeedbackDialog=function(){b.morselTitle=
b.morsel.title;"Video"===b.morsel.model?(g.pauseVideo(),b.feedbackOptions=j):b.feedbackOptions=k;c.activate("feedback")};var l=function(a){for(var a=_.pairs(a),b={},c=0;c<a.length;++c){var d=a[c][0],e=a[c][1];if(_.isObject(e))for(var e=_.pairs(l(e)),f=0;f<e.length;++f)b[d+"."+e[f][0]]=e[f][1];else void 0!==e&&null!==e&&(b[d]=e)}return b};b.submitFeedback=function(){b.formValidationResults=a.check(b.form);if(b.formValidationResults.valid){var j=[{context:e.getCurrent(),data:{model:"SurveyResponse",
survey_name:"LessonFeedback"}}],k={reason:b.form.feedbackReason.value,explanation:b.form.feedbackExplanation.value,techDetect:f.getAllTech(),currentUrl:window.location.href};"Video"===b.morsel.model&&(k=_.extend(k,{youtube:{availablePlaybackRates:g.getAvailablePlaybackRates(),currentPlaybackRate:g.getCurrentPlaybackRate(),currentTime:g.getCurrentTime()}}));k=l(k);j[0].data.items=_.map(_.pairs(k),function(a){return{name:a[0],content:a[1]}});d.send(j);c.confirm();b.form.feedbackReason.value=null;b.form.feedbackExplanation.value=
null;c.activate("feedback-confirmation").then(function(){"Video"===b.morsel.model&&g.playVideo()})}}}]}}]);angular.module("viewer").factory("codeEditor",["mixin","codeMirror","libraryLoader",function(a,d,b){function c(a){return-1!==a.indexOf(".c")?"c":-1!==a.indexOf(".cpp")?"cpp":-1!==a.indexOf(".css")?"css":-1!==a.indexOf(".cu")?"cuda":-1!==a.indexOf(".e")?"specman":-1!==a.indexOf(".glsl")?"glsl":-1!==a.indexOf(".html")?"html":-1!==a.indexOf(".java")?"java":-1!==a.indexOf(".js")?"javascript":-1!==a.indexOf(".json")?"javascript":-1!==a.indexOf(".m")?"octave":-1!==a.indexOf(".py")?"python":-1!==a.indexOf(".r")?
...
setActiveLanguage:function(a){c=a;b.setOption("mode",e[a]);h.emitEvent("languageChanged",{to:a})},getActiveLanguage:function(){return c},setOptions:function(a){_.each(a,function(a,c){b.setOption(c,a)})},getContents:function(){return b?b.getValue():null},setContents:function(a){b.setValue(a)}};return a.eventEmission(h,["attached","languageChanged","contentChanged"])}]);angular.module("viewer").service("executor",["mixin","api","dateTime","lessonContentContext","lesson","iframeEvaluator","$location",function(a,d,b,c,e,f,g){var h={submitFiles:function(a,j,k){var l=k.operation||"TEST",m=c.getCurrent(),p=b.getCurrentAsUTC(),n={model:"Submission",operation:l,parts:_.map(a,function(a){return{model:"SubmissionPart",marker:a.name,content:a.content}})},r={submission:n,client_route:"!"+g.path()},q=function(a){h.emitEvent("evaluation",{evaluation:a.data.evaluation,submission:n,
context:m,timestamp:p});return a};h.emitEvent("submit");e.updateLastSubmissionForMorsel(j,n);return k.useIframe?f.evaluate(n,j,k.iframeUrl).then(function(a){r.submission.client_execution=a.execution;r.submission.client_execution.raw_result=JSON.stringify(a.execution.raw_result);return d.post("/nodes/"+j+"/evaluation?_method=GET",r,{timeout:3E4}).then(q)},function(){r.execution={model:"SubmissionExecution",raw_result:"",status:"te"};return d.post("/nodes/"+j+"/evaluation?_method=GET",r,{timeout:3E4}).then(q)}):
d.post("/nodes/"+j+"/evaluation?_method=GET",r,{timeout:3E4}).then(q)}};return a.eventEmission(h,["update","submit","evaluation"])}]);angular.module("viewer").factory("firebaseGoals",["$timeout","$q","mixin",function(a,d,b){var c,e={init:function(b,d){c=new window.Firebase("https://coach-goals.firebaseio.com");c.child(b).child(d).on("value",function(b){_.isObject(b)&&a(function(){e.emitEvent("updatedGoals",b.val())})})},postCompletedUpdate:function(a,b,d){c.child(a).child(b).child(d).update({state:{complete:!0,completed_time:window.Firebase.ServerValue.TIMESTAMP}},function(a){a?e.emitEvent("updateFailed",a):e.emitEvent("goalComplete",
d)})}};return b.eventEmission(e,["updatedGoals","goalComplete","updateFailed"])}]);angular.module("viewer").factory("forumService",["$http","$q","optimizely",function(a,d,b){return{getPosts:function(c,e,f,g){var h=d.defer();window.FORUM_JSONP_CALLBACK=function(a){h.resolve(_.first(_.map(a,function(a){return{title:a.title,href:a.href+"#"+g.key,date:a.date,score:a.score,answer_count:a.answer_count,views:a.views,important:a.important}}),f))};a.jsonp("https://forums.udacity.com/tags/"+c+"/interesting/?callback=FORUM_JSONP_CALLBACK").success(function(a){return a}).error(function(){})["finally"](function(){window.setTimeout(b.activate,
...
k[a.tidbit_ref.key];a.tidbit_ref&&(a.tidbit_ref.containingExercise=c)}));k[a.key].indexInLesson=b});_.each(k,function(a){if("ImageFormQuiz"===a.model||"ProgrammingQuiz"===a.model)a.binCodes=[]});if(d=_.find(f.nodestates,function(a){return a.node_ref.key===b}))_.each(d.completed_descendant_node_refs,function(a){n.markMorselAsCompleted(a.key)}),(d=g(d.last_interactions,c.getCurrent()))&&d.morselKey&&(a=k[d.morselKey]);n.emitEvent("lessonChange",{lesson:j,morsels:_.map(j.steps_refs,function(a){return k[a.key]}),
lastMorselVisited:a})}},function(a){e===m&&a&&(a.status&&(403===a.status||404===a.status))&&n.emitEvent("lessonPermissionDenied",b)})},announcePendingMorselChange:function(a){n.emitEvent("pendingMorselChange",{from:l,to:a})},changeMorsel:function(a){l=k[a];n.emitEvent("morselChange",l)},changeTidbit:function(a){n.emitEvent("tidbitChange",{tidbit:a?k[a]:null})},markMorselAsCompleted:function(a){k[a]?k[a].completed=!0:console.error("Can't find morsel #"+a+" to mark it as completed")},updateProgressForMorsel:function(a,
b){k[a]&&k[b]?k[a].progressNodeId=b:console.error("Can't find container morsel #"+a+" or perhaps progress morsel #"+b+" to update progress")},updateLastSubmissionForMorsel:function(a,b){k[a]?k[a].lastSubmission=b:console.error("Can't find morsel #"+a+"to update activity")},mergeBinCodesForMorsel:function(a,b){k[a]&&(k[a].binCodes=_.union(k[a].binCodes,b))}};return b.eventEmission(n,"pendingCourseChange courseChange pendingLessonChange lessonChange pendingMorselChange morselChange tidbitChange lessonPermissionDenied coursePermissionDenied".split(" "))}]);angular.module("viewer").factory("lessonPrefetcher",["$http","$timeout","lesson",function(a,d,b){var c=null;b.addEventListener("courseChange",function(a){c=a.lessons},{replayLast:!0});b.addEventListener("courseChange",function(){b.addEventListener("lessonChange",function(b){var f=_.find(c,function(a){return a.key===b.lesson.key}).indexInCourse;if(0<f){var g=c[f-1].key;d(function(){a.get("/api/nodes/"+g+"?depth=2&fresh=false&required_behavior=view&projection=classroom")},1E4,!1)}if(0<=f&&f<c.length-
...
l.evaluator.external_uri};q.emitEvent("submitting",{morselId:n,submissionOptions:g});c.submitFiles(f(b.getAllFiles()),n,g).then(function(b){b=b.data;if(a===j&&d===l.key){e.mergeBinCodesForMorsel(d,b.evaluation.bin_codes);if(b.evaluation.passed||0<b.evaluation.score.points_earned)e.markMorselAsCompleted(d),r.containingExercise&&e.markMorselAsCompleted(r.containingExercise.key);b.evaluation.comment&&b.evaluation.comment.indexOf("est case input")&&(q.emitEvent("run",{morselId:d,result:{stdout:b.evaluation.comment,
stderr:null,images:null}}),b.evaluation.comment=b.evaluation.feedback?b.evaluation.feedback:"Please see detailed feedback in the output area below.");q.emitEvent("evaluated",{quiz:l,result:b.evaluation})}},function(a){q.emitEvent("evaluationError",a.data)})},run:function(){var a=Math.round((new Date).getTime()),d=l.key;k=a;c.submitFiles(f(b.getAllFiles()),n,{operation:"TEST",useIframe:l.evaluator&&"IFrameEvaluator"===l.evaluator.model,iframeUrl:l.evaluator&&l.evaluator.external_uri}).then(function(b){b=
b.data;if(a===k&&d===l.key){var c={};b.execution&&b.execution._output_attachments&&(c=b.execution._output_attachments,b=g(b.execution._ordered_file_attachments),c={stdout:c.stdout?c.stdout._content._plaintext:null,stderr:c.stderr?c.stderr._content._plaintext:null,images:_.filter(b,function(a){return"image"===a.kind})});q.emitEvent("run",{morselId:d,result:c})}},function(a){q.emitEvent("runError",a.data)})},reset:function(){b.loadFiles(p)}};return d.eventEmission(q,"submitting evaluated evaluationError run runError ready".split(" "))}]);angular.module("viewer").factory("studentGoals",["$q","$routeParams","firebaseGoals","nodes","lesson","currentUser","imageQuiz","programmingQuiz","dateTime",function(a,d,b,c,e,f,g,h,i){var j="loading",k,l={},m,p;b.addEventListener("updatedGoals",function(a){l=a;_.each(l,function(a){a.state=a.state||{complete:!1}});var b,d;_.each(a,function(a,c){if("visit"!==a.type&&(!b||a.created_time>b.created_time))d=c,b=a});j=(k=d||null)?l[k]:null;p=null;j&&(p=Math.floor(i.calculateDaysBetweenDates(i.getCurrent(),
new Date(j.target_time))),j.type&&"milestone"===j.type&&(j.milestoneData="loading",c.batchGet(j.config.milestones).then(function(a){j.milestoneData=a;n.checkGoal(j)})))},{replayLast:!0});e.addEventListener("lessonChange",function(a){m=a;n.checkGoal(j)},{replayLast:!0});g.addEventListener("correct",function(){n.checkGoal(j)},{replayLast:!0});h.addEventListener("evaluated",function(){n.checkGoal(j)},{replayLast:!0});var n={currentLesson:function(){return m},getCurrent:function(){return j},getCurrentKey:function(){return k},
checkGoal:function(a){if(!a||"milestone"!==a.type||!a.state||a.state.complete||!m)return!1;if(a.config.milestones[0]===m.lesson.key){var a=_.reduce(m.morsels,function(a,b){if("Exercise"===b.model||"ImageFormQuiz"===b.model||"ProgrammingQuiz"===b.model)a[0]+=1,b.completed&&(a[1]+=1),a[2].push(b.completed);return a},[0,0,[]]),c=_.reduce(a[2].slice(-4),function(a,b){return a+b},0);if(8<a[0]&&0.85<=a[1]/a[0]&&4===c||8>=a[0]&&a[0]===a[1])j.state.complete=!0,b.postCompletedUpdate(f.get("key"),d.courseKey,
k)}return!1},daysUntilCurrentGoalDue:function(){return p},init:function(a,c){b.init(a,c)}};return n}]);angular.module("viewer").factory("tidbits",[function(){return{isTidbitRelevant:function(a,d,b){return _.some(a.bin_code_groups,function(a){return(!b||a.bin_codes.length)&&_.every(a.bin_codes,function(a){return _.contains(d,a)})})},getTidbitViewerMode:function(a){return a?"tidbit-only":"quiz-only"}}}]);angular.module("viewer").constant("viewerPartialMap",{Video:{prefix:"video"},SketchVideo:{prefix:"video"},ProgrammingQuiz:{prefix:"programming_quiz",extension:!0},ImageFormQuiz:{prefix:"image_quiz"},Sketch:{prefix:"sketch"},EmbeddedFrame:{prefix:"iframe"},Reading:{prefix:"reading"}});angular.module("viewer").factory("viewerSettings",["mixin",function(a){var d={autoPlay:!0},b={set:function(a,e){if(d.hasOwnProperty(a)){var f=d[a];d[a]=e;b.emitEvent("change",{name:a,oldValue:f,newValue:e})}else console.error("can't set invalid setting: "+a)},get:function(a){if(d.hasOwnProperty(a))return d[a];console.error("Can't get invalid setting: "+a)}};return a.eventEmission(b,["change"])}]);angular.module("widgets").factory("github",["$q","libraryLoader","$rootScope","cookieJar",function(a,d,b,c){var e=d.loadLibraries(["base64"]),f={Accept:"application/vnd.github.raw","Content-Type":"application/json"},g={scopes:["repo"],note:"Udacity Issue Tracker",client_id:"bb427a8f7beb27b582e0",client_secret:"a014d61f827e1a761898d216ce44e23431237973"},h=null;(d=c.get("githubIssueTrackerToken"))&&(h=d);var i={setToken:function(a){null===a&&c.remove("githubIssueTrackerToken");h=a},hasToken:function(){return null!==
h},getAuth:function(d,g,l){var m=a.defer();e.then(function(){var a=angular.copy(f);a.Authorization="Basic "+Base64.encode(d+":"+g);l&&(a["X-GitHub-OTP"]=l);$.ajax("https://api.github.com/authorizations",{headers:a}).done(function(a){_.each(a,function(a){"bb427a8f7beb27b582e0"===a.app.client_id&&(i.setToken(a.token),c.set("githubIssueTrackerToken",a.token))});null!==h?m.resolve(a):i._postAuth(d,g,l).then(function(a){m.resolve(a)},function(a){m.reject(a)})}).fail(function(a){m.reject(a)}).always(function(){b.$apply()})});
...
"text/x-ocl"],["ocl","ocl","text/x-ocl"],["r","r","text/x-rsrc"],["xml","xml",{name:"xml",htmlMode:!1}]],c=_.object(_.map(b,function(a){return[a[0],a[1]]})),e=_.object(_.map(b,function(a){return[a[1],a[2]]})),f=_.object(_.map(b,function(a){return[a[0],a[2]]}));d.getCodeMirrorSpecifierForLanguage=function(a){return e[a]};d.getCodeMirrorSpecifierForFileName=function(a){a=_.last(a.split("."));return f[a]};d.getLanguageForFileName=function(a){a=_.last(a.split("."));return c[a]};var g=function(a){for(var b=
...
new YT.Player(a,b)};c.emitEvent("apiReady")};c.getAvailablePlaybackRates=function(){return e.getAvailablePlaybackRates()};c.getCurrentPlaybackRate=function(){return e&&e.getPlaybackRate?e.getPlaybackRate():f};c.setPlaybackRate=function(a){f=a;window.setTimeout(function(){e.setPlaybackRate(a)},500)};c.setPlaybackQuality=function(a){f=a;e.setPlaybackQuality(a)};c.playVideo=function(){e&&e.playVideo?e.playVideo():console.error("The video player isn't ready or there is no video player on this page!")};
c.pauseVideo=function(){if(e&&e.pauseVideo&&e.getCurrentTime){try{e.pauseVideo()}catch(a){console.error("YouTube threw an error while trying to call its own pause function!",a)}c.emitEvent("videoPause",Math.floor(e.getCurrentTime()))}};c.stopVideo=function(){e.stopVideo()};c.destroyVideo=function(){e.stopVideo();e.destroy()};c.loadVideo=function(a,b,d){e.loadVideoById?(e.loadVideoById(a,b||0,d||g),c.setPlaybackRate(f),c.setPlaybackQuality(g)):c.addEventListener("ready",function(){e.loadVideoById(a,
b||0,d||g)},{removeAfterFired:!0})};c.getCurrentTime=function(){return e&&e.getCurrentTime?Math.floor(e.getCurrentTime()):null};return a.eventEmission(c,"apiReady ready videoEnd videoPlay videoPause playbackRateChange playbackQualityChange".split(" "))}]);
