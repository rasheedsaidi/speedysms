...
<div class="credit-form">
    ...
    <?= $form->field($model, 'price_id')->dropDownList(Price::find()->select(['price'])->indexBy('id')->column(), ['prompt'=>'Select Price']) ?>
	<?= $form->field($model, 'type')->dropDownList(['express' => 'Express', 'standard' => 'Standard'], ['prompt'=>'Select Price']) ?>
